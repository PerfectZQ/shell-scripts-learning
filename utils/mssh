...
# ====================================================================================================================================================
# ======== 配置 当前用户 到多个目标节点的免密登陆，目标节点的密码需要相同！ 
# ======== Created by zhang_qiang_neu on 2018-5-24 
# ======== Usage: args [-h "host1 [host2 host3]"] [-p "password"] 
# ======== Examples: ./ssh_configure.sh -h "neu@10.4.124.98 neu@10.4.124.99 neu@10.4.124.100" -p "password"
# ====================================================================================================================================================
